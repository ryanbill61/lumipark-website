    ...
    <div className="max-w-7xl mx-auto px-5 md:px-8 pt-12 md:pt-16">
      ...
      <div className="mt-6 grid gap-10 lg:grid-cols-[1fr_400px]">
        ...
        <div className="min-w-0">
          {/* 1. Gallery */}
          <section>
            <div className="rounded-xl overflow-hidden border border-ink/10 bg-[#f5f5f7]">
              <Img
                ...
                >
                  <span
                    className={`block aspect-square w-full rounded-lg overflow-hidden border transition-colors ${
                      i === selected ? "border-steel" : "border-transparent group-hover:border-black/40"
                    }`}
                  >
                    {galleryImages[i] ? (
                      <img
          ...
          <section className="mt-10">
            ...
            {appImages.length === 0 ? (
              ...
              <div className="relative rounded-xl overflow-hidden border border-ink/10 bg-[#f5f5f7]">
                <Img
        ...
        <div className="min-w-0">
          <div className="lg:sticky lg:top-24">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {["UL LISTED", "CE", "ETL"].map((c) => (
                <span
                  key={c}
                  className="inline-block border border-[#D1D1D1] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.5px] text-[#737373]"
                >
                  {c}
                </span>
              ))}
