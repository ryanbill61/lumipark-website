...
const SITE_EMAIL = "ryan@leappon.com";
const SITE_NAME = "LEAPPON";
// leappon.com is verified in Resend; Alibaba MX verification passed.
const FROM_EMAIL = "ryan@leappon.com";
// Real inbox (Alibaba enterprise mail) that receives the internal notification.
