...
const MILESTONES = [
  ...
  { value: "36", label: "Years of lighting manufacturing" },
  { value: "20+", label: "Years in North America" },
...
export default function About() {
  usePageMeta(
    ...
    "Inside LumiPark's three lighting parks — 83,000 m², 50+ resident factories, one ISO 9001 QC standard from IQC to OQC.",
  );
  return (
    <div className="max-w-7xl mx-auto px-5 md:px-8 pt-16 md:pt-24">
      ...
      <section className="mt-20">
        ...
        <div className="mt-8 max-w-3xl space-y-5 text-ink-soft leading-relaxed">
          ...
          <p>
            Today the parks host 50+ factories across 83,000+ m² — while our own manufacturing core
          ...
          <p>
            Our commitment to North America is simple, and it is 20+ years old: brand-level
